...
export const S = {
  ...
  iconBtn: { background: "var(--surface-sunken)", border: "1px solid var(--surface-raised)", borderRadius: 8, color: "var(--muted2)", width: 32, height: 32, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" },
  ...
  evolutionEmpty: { fontSize: 12.5, color: "var(--muted2)", lineHeight: 1.7 },
  ...
  evolutionSummary: { fontSize: 13.5, color: "var(--ink-soft)", lineHeight: 1.8, margin: "0 0 10px" },
  ...
  entryTime: { textAlign: "end", fontSize: 11.5, color: "var(--muted2)", whiteSpace: "nowrap" },
  ...
  emptyStateTitle: { fontSize: 14, fontWeight: 600, color: "var(--muted2)" },
  ...
  quickTaskText: { fontSize: 13, color: "var(--ink-soft)" },
  ...
  taskInput: { flex: 1, background: "var(--surface-sunken)", border: "1px solid var(--border2)", borderRadius: 12, padding: "12px 14px", color: "var(--ink)", fontSize: 14, fontFamily: "inherit" },
  ...
  catMini: { display: "flex", alignItems: "center", gap: 5, border: "1px solid var(--border2)", borderRadius: 20, padding: "5px 10px", fontSize: 11.5, color: "var(--ink-soft)", cursor: "pointer", fontFamily: "inherit", whiteSpace: "nowrap", flexShrink: 0 },
  ...
  dayChipWeekday: { fontSize: 10, color: "var(--muted2)", fontWeight: 600 },
  ...
  taskTag: { display: "flex", alignItems: "center", gap: 4, fontSize: 11, color: "var(--muted2)" },
  ...
  chartTitle: { fontSize: 13, fontWeight: 600, color: "var(--muted2)", marginBottom: 8, paddingInlineStart: 4 },
  ...
  achieveHeroSub: { fontSize: 12, color: "var(--muted2)", marginTop: 2, lineHeight: 1.5 },
  ...
  achieveTopic: { fontSize: 10.5, color: "var(--muted2)" },
  ...
  achieveToggle: { display: "flex", alignItems: "center", gap: 5, background: "none", border: "none", color: "var(--muted2)", fontSize: 12, fontWeight: 600, cursor: "pointer", fontFamily: "inherit", padding: 0, marginBottom: 8 },
  achieveSteps: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 10, paddingInlineStart: 2 },
  ...
  commitBarWrap: { height: 7, background: "var(--line)", borderRadius: 4, overflow: "hidden", marginBottom: 6 },
  commitBarFill: { height: "100%", borderRadius: 4, transition: "width 0.3s" },
  commitProgress: { fontSize: 11, color: "var(--muted2)" },
  ...
  defaultsBtn: { display: "flex", alignItems: "center", gap: 5, background: "rgba(95,168,160,0.1)", border: "1px solid rgba(95,168,160,0.3)", borderRadius: 20, padding: "6px 12px", fontSize: 12, color: "#5FA8A0", cursor: "pointer", fontFamily: "inherit", fontWeight: 600, marginInlineEnd: "auto" },
  ...
  subTabActive: { background: "var(--surface-raised)", color: "var(--gold)" },
  ...
  adjustBtnSmall: { background: "transparent", border: "1px solid var(--border2)", color: "var(--muted2)", borderRadius: 8, padding: "7px 11px", fontSize: 12.5, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" },
  ...
  studyToggle: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, background: "transparent", border: "1px solid var(--border2)", borderRadius: 10, padding: "9px 0", fontSize: 12.5, color: "var(--muted2)", cursor: "pointer", fontFamily: "inherit", fontWeight: 600 },
  studyToggleActive: { background: "rgba(95,168,160,0.1)", borderColor: "rgba(95,168,160,0.4)", color: "#5FA8A0" },
  memoryNote: { display: "flex", gap: 8, alignItems: "flex-start", background: "var(--surface-sunken)", border: "1px solid var(--line)", borderRadius: 10, padding: "10px 12px", fontSize: 11.5, color: "var(--muted2)", lineHeight: 1.6, marginBottom: 16, marginTop: 12 },

  sessionLog: { display: "flex", flexDirection: "column", gap: 6 },
  sessionRow: { display: "flex", alignItems: "center", gap: 8, fontSize: 12.5, padding: "6px 0", borderBottom: "1px solid var(--surface-sunken)" },
  ...
  sessionDate: { color: "var(--muted)", fontSize: 11, fontVariantNumeric: "tabular-nums", minWidth: 48, textAlign: "end" },
  ...
  leadPill: { marginInlineEnd: "auto", background: "rgba(201,162,75,0.12)", color: "var(--gold)", fontSize: 10.5, fontWeight: 700, padding: "3px 10px", borderRadius: 20 },
  ...
  botYou: { background: "rgba(201,162,75,0.12)", color: "var(--gold)", fontSize: 10, padding: "1px 6px", borderRadius: 10, marginInlineStart: 5 },
  botTrait: { fontSize: 11, color: "var(--muted)", marginBottom: 6 },
  botBarWrap: { height: 5, background: "var(--line)", borderRadius: 3, overflow: "hidden" },
  ...
  moodBtn: { background: "var(--surface-sunken)", border: "1px solid var(--border2)", borderRadius: 20, padding: "7px 14px", fontSize: 12.5, color: "var(--ink-soft)", cursor: "pointer", fontFamily: "inherit", fontWeight: 600 },
  coachLoading: { display: "flex", alignItems: "center", gap: 8, fontSize: 12.5, color: "var(--muted2)", marginTop: 8 },
  coachReply: { background: "rgba(255,255,255,0.03)", border: "1px solid var(--border2)", borderRadius: 12, padding: "12px", marginTop: 8 },
  coachMessage: { fontSize: 13, color: "var(--ink-soft)", lineHeight: 1.7, marginBottom: 8 },
  coachActivity: { display: "flex", alignItems: "center", gap: 7, fontSize: 13, fontWeight: 700, color: "var(--gold)", marginBottom: 6 },
  coachWhy: { fontSize: 12, color: "var(--muted2)", lineHeight: 1.6 },
};
