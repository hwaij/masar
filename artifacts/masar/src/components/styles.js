...
export const S = {
  ...
  entryTime: { textAlign: "left", fontSize: 11.5, color: "var(--muted2)", whiteSpace: "nowrap" },
  ...
  sessionDate: { color: "var(--muted)", fontSize: 11, fontVariantNumeric: "tabular-nums", minWidth: 48, textAlign: "left" },
