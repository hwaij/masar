// ============================================================
// طبقة التخزين: تكتب وتقرأ من Supabase إن توفّر، ومن localStorage
// كنسخة احتياطية دائماً، بحيث لا تُفقد البيانات أبداً.
// ============================================================
...
// ============================================================
// تحويل أسماء الأعمدة بين قاعدة البيانات (snake) والواجهة (camel)
// ============================================================
...
// ============================================================
// واجهة عامة موحّدة
// كل دالة تحدّث localStorage فوراً ثم تزامن مع Supabase إن وُجد.
// ============================================================
...
export const store = {
  ...
  async savePrayer(entry) {
    const local = lsGet("masar_prayer_log", []);
    // منع التكرار لنفس الصلاة في نفس اليوم
